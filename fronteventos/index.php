...
<head>
    ...
    <title>Front End en HTML y php</title>
</head>
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="#">Une Chose</a></li>
                                <li><a class="dropdown-item" href="#">Autre Chose</a></li>
                                <li>
                                    <hr class="dropdown-divider">
                                </li>
                                <li><a class="dropdown-item" href="clientes_pdf.php" target="_blank">Generar Reporte</a></li>
                            </ul>
                        </li>
                        <li class="nav-item">
